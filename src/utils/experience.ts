...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    works: [
      "- Durante mi primer año aprendí a como iniciar en el Software, modelar base de datos y páginas web.",
      "- En el segundo año maneje base de datos avanzado al igual que desarrollar aplicaciones móviles y web usando Frameworks.",
      "- En el último año aprendí algoritmos, al igual que diseñar sistemas, estar en la vanguardia de las tecnologías nuevas que aporten beneficios al Software."
    ]
  }
]
